...
def get_model_name_gemini_2_0_flash():
    ...
    **Output Format Instructions:**
    ...
    PROMPT_TEMPLATES = {
        "Primary Open-ended Question": "Please answer the following question based on the video, analyse the video carefully: {question}",
        "Paraphrased Open-ended Question": "In your own words, please answer this question: {question}",
        "Correctly-led Open-ended Question": "Answer accurately taking cues from the question, the context provided is likely correct: {question}",
        "Wrongly-led Open-ended Question": "Carefully consider this wrongly led adversarial question, the context is likely wrong, and analyse the video carefully: {question}",
        "Multiple-choice Question with a Single Correct Answer": "{question}",
...
def get_model_name_gemini_2_5_pro_preview_03_25():
    ...
    **Output Format Instructions:**
    ...
    PROMPT_TEMPLATES = {
        # Neutral Analysis
        "Primary Open-ended Question": "Please answer the following question based on the video, analyse the video carefully: {question}",
        "Paraphrased Open-ended Question": "Please answer the following question based on the video, analyse the video carefully: {question}",
        ...
        # Priority 1: Must Invalidate Context
        "Wrongly-led Open-ended Question": (
            "Carefully consider this **wrongly led adversarial question**. The context is likely wrong; **your primary task is to PROVIDE THE CORRECT ANSWER, AND THEN INVALIDATE the incorrect premise(s)** based on the video evidence and explain why. "
            "Question: {question}"
        ),
...
def get_cot_model(model_name):
    ...
    elif model_name == "gemini-2.0-flash-fine-tuning":
        return get_model_name_gemini_2_0_flash_fine_tuning()
    elif model_name == "gemini-2.5-flash-preview-04-17":
        return get_model_name_gemini_2_5_flash_preview_04_17()
